...
echo "🔧 Fixing JWT StringValue type issue..."

# ============================================================================
# Fix JWT token expiry types with proper type assertion
# ============================================================================

cat > src/security/auth/auth.service.ts << 'EOF'
...
echo ""
echo "✅ JWT StringValue type issue fixed!"
echo "🔧 Applied fix:"
echo "   - Used type assertion 'as any' to bypass StringValue type restriction"
echo "   - Simplified tokenExpiry properties back to plain strings"
echo ""
echo "🚀 Run: npm run type-check"
echo "   Should show 0 errors now! 🎉"