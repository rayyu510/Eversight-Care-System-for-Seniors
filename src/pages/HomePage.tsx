...
const HomePage = () => {
    const [activeModule, setActiveModule] = useState('operations-center');
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
            ...
            <div style={{
                ...
                {/* Logo Section - Top Left with White Background */}
                <div style={{
                    padding: '20px 24px',
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: '12px', color: '#9ca3af' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
                            ...
                            <span style={{ color: '#10b981' }}>97% Operational</span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <span>Last Update:</span>
                            <span style={{ color: '#e5e7eb' }}>Real-time</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div>
                            ...
                            <p style={{
                                ...
                                Central Healthcare Management Dashboard
                            </p>
                        </div>
                ...
                <div style={{ padding: '24px', backgroundColor: '#f9fafb', flex: '1' }}>
                    ...
                    {/* Upper Section: Operations & Surveillance Centers */}
                    <div style={{
                        display: 'grid',
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                ...
                                <div style={{
                                    ...
                                    <div style={{ flex: '1' }}>
                                        <div style={{ fontSize: '14px', fontWeight: '500', color: '#111827' }}>
                                            Health Prediction Update
                                        </div>
                                        <div style={{ fontSize: '12px', color: '#6b7280' }}>
                                            Guardian Insight - Risk Assessment
                                        </div>
                                    </div>
                                    <div style={{ fontSize: '12px', color: '#9ca3af' }}>12 min ago</div>
                                </div>
                            </div>
                        </div>
